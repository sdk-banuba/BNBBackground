...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-199-g2f4e3cf953/BNBBackground.zip",
            checksum: "58da605fd2b69d806344c326086be024c98832bda4b78cf61e5d4bb4edad3e72"
        ),
        .target(
