...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-183-gf9e3d7354f/BNBBackground.zip",
            checksum: "c3260490e43632a961e1d385f5d4a560f2394454f9c8689462b9dfb9f368b60b"
        ),
        .target(
