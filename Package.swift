...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-132-g6a6b08380/BNBBackground.zip",
            checksum: "2d7dd5b62bcb7181e070ba7aa665ca55aa35749607c0062a9350feb5d8bee4c7"
        ),
        .target(
