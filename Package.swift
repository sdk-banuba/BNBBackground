...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-gf86664003c/BNBBackground.zip",
            checksum: "7044a2b85ca5547b74b61ac4d420d75d7681b3988d61262b061bc7db29eaf27e"
        ),
        .target(
