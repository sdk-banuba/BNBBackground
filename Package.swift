...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-71-gf7bd3a54e/BNBBackground.zip",
            checksum: "4711efa326b43643c5f515fc8648a1559db1aa1d3fd90d66d71afc5d763304eb"
        ),
        .target(
