...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-219-gefae079ac3/BNBBackground.zip",
            checksum: "e76104c08378840388b320dcc4063d6e749aac3acde64485e4a0178809e39932"
        ),
        .target(
