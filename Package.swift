...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-105-gb559f9611/BNBBackground.zip",
            checksum: "b4be6ad93fb31a8f3611180ad3391a95e134484fb8b5830a92ec6bad3e395733"
        ),
        .target(
