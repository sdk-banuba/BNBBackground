...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-216-gc859e59035/BNBBackground.zip",
            checksum: "cf8e604b7e14adaba6a6d44ef00c671cc55a4c3a9da14ea6bd5e63f723eecc44"
        ),
        .target(
