...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-271-g70b8136591/BNBBackground.zip",
            checksum: "fefc53306bed27b9c7acb1d6d5dd0ae2297513904f2d91b9b3c0c0cd133e1de2"
        ),
        .target(
