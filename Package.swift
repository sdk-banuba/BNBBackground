...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-173-gee6f2723a/BNBBackground.zip",
            checksum: "1378b3c141229d6728cc339e8a9d741e096bf76de391b41e386c776dc956e72c"
        ),
        .target(
