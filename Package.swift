...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.0-19-gb88228b6f/BNBBackground.zip",
            checksum: "25027cae980b3ff9aee0c0ee0d7b56c35761be07436c45c690dbb772c7157de2"
        ),
        .target(
