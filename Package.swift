...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-69-g431d04ab4a/BNBBackground.zip",
            checksum: "51010640bd03fae761fd152a566dd75aef43661f385bd63d277882ef3a5e8cdc"
        ),
        .target(
