...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.0-66-g886631a577/BNBBackground.zip",
            checksum: "3d339bae44bd195fc43c3248860c0ef15b4cf23c6822e2c7522d65fbaacb4620"
        ),
        .target(
