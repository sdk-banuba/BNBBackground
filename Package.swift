...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.2-5-gf3828971b9/BNBBackground.zip",
            checksum: "b2929a064339298352a2f15b52beed11d097464a4bb4de63511ec2ebbdaf907b"
        ),
        .target(
