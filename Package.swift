...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-75-g381c51d93/BNBBackground.zip",
            checksum: "b0e15f60a7ced5887a748fee40dc16fae63c5458390ac201bd1fc4877a5afb0b"
        ),
        .target(
