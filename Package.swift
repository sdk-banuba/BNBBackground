...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-86-g65c1c833d4/BNBBackground.zip",
            checksum: "eacf80c5c513e6b46860483544f57b03a69114c2028aa8bb16c8bf5c59db6a44"
        ),
        .target(
