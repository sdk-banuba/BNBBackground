...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-74-g9d1b0a47e/BNBBackground.zip",
            checksum: "523d5a3e86e68c0461aed9decfef5df9b848ce6a2abbd1c1aa699508c5b7e151"
        ),
        .target(
