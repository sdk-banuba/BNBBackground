...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-143-g50b5f987b/BNBBackground.zip",
            checksum: "48c09ceb58cc18c48c3900cfb5eef82a1b7cfedf332ce0f6c540ddd9d0e7055b"
        ),
        .target(
