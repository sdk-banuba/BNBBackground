...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-40-gb99e5d381/BNBBackground.zip",
            checksum: "9c72e92231d308345e6e6289fa1ceae25eb1b0008d84c9ed15d1cc36a35f7093"
        ),
        .target(
