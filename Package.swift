...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-33-g6de24312a/BNBBackground.zip",
            checksum: "8a58aed95092eb945dfd70c3e6a1d62590701eb206bd3915c79797ed385a325e"
        ),
        .target(
