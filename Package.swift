...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-174-gec051bdc7/BNBBackground.zip",
            checksum: "8419c95519e382efedac24000204f5b54d4727cabe278eb9986cda2c255736e5"
        ),
        .target(
