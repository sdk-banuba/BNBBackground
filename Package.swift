...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g91aac4bda/BNBBackground.zip",
            checksum: "521b7d9222a8d17a57ab3428fa380c5ed9080fa0cde1a8b49c26e65a2964b2f2"
        ),
        .target(
