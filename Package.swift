...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-68-g8184560bc/BNBBackground.zip",
            checksum: "5562b0990289e68d44e8f7d9af90c45db4875b75e36399c7b16ad63a73c2aee1"
        ),
        .target(
