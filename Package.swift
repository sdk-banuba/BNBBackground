...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-33-gdff1aad66/BNBBackground.zip",
            checksum: "f2c02d7245c6f52c03e86d2232027cd684c9491d4b38883b5863b65226c0b8f6"
        ),
        .target(
