...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-138-g40eb4c9af/BNBBackground.zip",
            checksum: "59745ffe3e7eba61507d6ce0e4cc69aba456195f6e0fed95899d39427c8431b3"
        ),
        .target(
