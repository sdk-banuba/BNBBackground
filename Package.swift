...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-180-gd5fc258816/BNBBackground.zip",
            checksum: "0de114ce805d2120ac9fd5e08391d1413f5a58c2752f7d6d5f18f0a8f5b1b668"
        ),
        .target(
