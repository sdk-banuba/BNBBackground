...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g93323bc96/BNBBackground.zip",
            checksum: "0067c9a8a202bb91c8bc6014c0a191d0397f4c6cf74379857e03c999446a6f3d"
        ),
        .target(
