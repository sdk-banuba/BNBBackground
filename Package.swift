...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-242-g622cf17fa4/BNBBackground.zip",
            checksum: "cfe56282e0d6347b8dc7b9fdb7e24fb0cb74f0122101c9639f02dfd10dd1983c"
        ),
        .target(
