...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-38-g9a4283c65/BNBBackground.zip",
            checksum: "6e4570bd2c4ba59919a0b5c2046f0f9490ecd950c6a8e548c788bce8288ff07d"
        ),
        .target(
