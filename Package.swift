...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-173-gec24d1c86/BNBBackground.zip",
            checksum: "877e80d20b1cc0c79ddca97ce4e92497590e351a9b50869390e5d7480356d086"
        ),
        .target(
