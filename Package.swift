...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-187-g0f5dcf5d80/BNBBackground.zip",
            checksum: "78b1a7beaf3c7bc8cbddf60497a295609bcb5defde383ff3cf8419f1db06afcf"
        ),
        .target(
