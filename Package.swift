...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-203-g2a72d3010f/BNBBackground.zip",
            checksum: "ca2e83cf6f98add91c30f5c3420c4a219ca957247619c4109b2446b447b380f8"
        ),
        .target(
