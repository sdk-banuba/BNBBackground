...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-136-g6ec65980f/BNBBackground.zip",
            checksum: "d00909d773d645455aaf98834a22a7cdcb2ba71db44d909c74a27f0dda775164"
        ),
        .target(
