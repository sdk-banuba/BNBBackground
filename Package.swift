...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-194-gb1629e3e8c/BNBBackground.zip",
            checksum: "836e3b80f71c21373dfdd3f72f1ecd246079a503a64ddc7e77a1a14a01fa1cf1"
        ),
        .target(
