...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.15.1-1-g11945c35fb/BNBBackground.zip",
            checksum: "482629f456d00a7cfd45cc71168ab3e3ffe950bc295d74160a3339f13ecbe4ee"
        ),
        .target(
