...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-g3b9a032012/BNBBackground.zip",
            checksum: "462b0c7b20a56facc1da8424e093d90d3ad05ba75b64df12b7574e1bdb7aa25b"
        ),
        .target(
