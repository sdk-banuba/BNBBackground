...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-150-gd7caecfaf/BNBBackground.zip",
            checksum: "96277c906b75d6713ecbe4257ed39b985d001e4dd3564ffb95794dd11a0b8caa"
        ),
        .target(
