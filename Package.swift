...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g9f1f1a3b1/BNBBackground.zip",
            checksum: "e69216fe6919b35ce51137d81d655f840b04ebfe2977706e0f30918e3e5dca64"
        ),
        .target(
