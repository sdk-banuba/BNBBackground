...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-177-gd98bf09f0/BNBBackground.zip",
            checksum: "c2f357b70ba957e7ee6a3736a22ec8cabbef5e29114d4c6c5b49c79a7e8885e6"
        ),
        .target(
