...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-146-g6f441498b/BNBBackground.zip",
            checksum: "6ce00c63d08f6cd0cc8b523677d97de3661cf27f87ae11fb201e9d1d97416838"
        ),
        .target(
