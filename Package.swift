...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g2e0f1ab74/BNBBackground.zip",
            checksum: "24bbdceb92fa8e18e0c68b795323c6b086cbbfac473628920acc9c0e923784e5"
        ),
        .target(
