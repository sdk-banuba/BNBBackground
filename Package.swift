...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-188-g3e9bf00b67/BNBBackground.zip",
            checksum: "263b30fbe45aa617fd8e73d68959e53f23f0a88354318ece138bff424f78afcf"
        ),
        .target(
