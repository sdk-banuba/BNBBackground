...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.1-73-g8d138045c3/BNBBackground.zip",
            checksum: "df7f38305250cdd7f5fcddd184bcbcaac880799530bbcaf77a1b33889c8a85db"
        ),
        .target(
