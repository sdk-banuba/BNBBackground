...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.0-33-g2b785861d0/BNBBackground.zip",
            checksum: "ead6e8401de639b333d6baf41035b2aa9759135a638020ebfcdb58f1cc679200"
        ),
        .target(
