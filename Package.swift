...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9ce64ef1c2/BNBBackground.zip",
            checksum: "d6bff9cadff72f46b2f442adb61c04b6aae8e1f1e350c2c25126de2ce5ecd091"
        ),
        .target(
