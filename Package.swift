...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-137-gc11b2b754/BNBBackground.zip",
            checksum: "3c401664f4a1a330a5417e705fef3d4547af31cde7e3471ec09489c8b59625ef"
        ),
        .target(
