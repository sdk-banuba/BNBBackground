...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.18.2-24-g50ecbc89fd/BNBBackground.zip",
            checksum: "1a9554df5f945a722b440bcba078e0da59073117341f5dd01e73d6d78a723c91"
        ),
        .target(
