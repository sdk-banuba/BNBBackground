...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-55-g4d630007f/BNBBackground.zip",
            checksum: "bd7b5351decfc85f97601534d4621bda3ca3f36627438e0188bce7e911182fe7"
        ),
        .target(
