...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gd8cb662170/BNBBackground.zip",
            checksum: "150bac5b372bdef0e31631e8ee504fdeadd3e33d8892fe31388fd57ea384f5eb"
        ),
        .target(
