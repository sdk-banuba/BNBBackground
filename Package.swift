...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9b253c9f0f/BNBBackground.zip",
            checksum: "678d828f0bbd4484deae4430039c12c59c02b614f9402728f0115974ea4072b9"
        ),
        .target(
