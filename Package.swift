...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.0-24-gb831098a87/BNBBackground.zip",
            checksum: "ce7b546093fff0e6c2b25067ab757ccb789b05739551e6e5300a2b9c8189acd9"
        ),
        .target(
