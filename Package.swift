...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-86-gb002ed1e38/BNBBackground.zip",
            checksum: "e82879c73cefcff48a51cbea54173feeeec65fd2681bcefb87617163ed571e5e"
        ),
        .target(
