...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-71-g826381c83/BNBBackground.zip",
            checksum: "e79fce3542b189ea5fcbeacdbf9affa43a9835d5a5025a6ac0a8b0a3909f445b"
        ),
        .target(
