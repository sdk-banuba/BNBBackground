...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-218-g91528edbf1/BNBBackground.zip",
            checksum: "3183ba393b0a984df41c9acd8e2fe89bf2f9187f9d8f1b7e330b653dff7b77af"
        ),
        .target(
