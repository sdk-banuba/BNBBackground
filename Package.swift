...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-124-gbdb47c5e3/BNBBackground.zip",
            checksum: "627227106af618d35694dfda2a961b0d15143094d474f76befef411f8fe5564c"
        ),
        .target(
