...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-61-gc1c7cef54/BNBBackground.zip",
            checksum: "edc935fade248b2da30e4863f73caa44a1fa858bcc5bc2656317141b649049d5"
        ),
        .target(
