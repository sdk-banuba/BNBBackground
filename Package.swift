...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-162-gcda6b9c4b/BNBBackground.zip",
            checksum: "c207b212248a4072f0a8eb3728cecd265d4f59f5d00a70a317906e2b8c1d19ef"
        ),
        .target(
